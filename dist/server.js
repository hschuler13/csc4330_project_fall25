...
const callbackHandler = async (req, res) => {
    ...
    try {
        ...
        const handleGitHubCallback = mod.handleGitHubCallback ?? mod.default;
        ...
        <html>
          ...
          <body>
            <div class="success-box">
              ...
              <div class="info"><strong>Email:</strong> ${result.user.email || 'Not available'}</div>
              <div class="info"><strong>Name:</strong> ${result.user.name || 'Not available'}</div>
